...
import com.training.pom.InvalidmemberPwdPOM;
...
public class CYTC_007
{
	...
	private InvalidmemberPwdPOM ch;
	private LoginPOM pm;
	...
	public void setUp() throws Exception {
		...
		Thread.sleep(3000);
		ch = new InvalidmemberPwdPOM(driver); 
	...
	public void changePass() throws InterruptedException
	{
		...
		Thread.sleep(2000);
          ...
          Thread.sleep(2000);
          ch.newpassword("divyaa");
          Thread.sleep(2000);
          ch.newconfirmpassword("123");
          ch.passsubmit();
